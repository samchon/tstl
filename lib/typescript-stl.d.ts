...
declare namespace std.base {
    ...
    abstract class Container<T> implements IContainer<T> {
        ...
        protected abstract handle_insert<InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator): void;
        protected abstract handle_erase<InputIterator extends base.Iterator<T>>(first: InputIterator, last: InputIterator): void;
        /**
         * @inheritdoc
         */
...
declare namespace std.base {
    ...
    abstract class MapContainer<Key, T> extends base.Container<Pair<Key, T>> {
         ...
         * @hidden
         */
        protected abstract insert_by_range<L extends Key, U extends T>(begin: MapIterator<L, U>, end: MapIterator<L, U>): void;
        /**
...
declare namespace std {
    ...
    class HashSet<T> extends base.UniqueSet<T> {
         ...
         * @hidden
         */
        protected insert_by_range<U extends T, InputIterator extends base.Iterator<U>>(first: InputIterator, last: InputIterator): void;
        /**
         * @inheritdoc
         */
...
declare namespace std {
    ...
    class HashMap<Key, T> extends base.UniqueMap<Key, T> {
         ...
         * @hidden
         */
        protected insert_by_range<L extends Key, U extends T>(first: MapIterator<L, U>, last: MapIterator<L, U>): void;
        /**
         * @inheritdoc
         */
...
declare namespace std {
    ...
    function prev<T, BidirectionalIterator extends base.Iterator<T>>(it: BidirectionalIterator, n?: number): BidirectionalIterator;
    function next<T, BidirectionalIterator extends base.Iterator<T>>(it: BidirectionalIterator, n?: number): BidirectionalIterator;
}
declare namespace std {
    /**
