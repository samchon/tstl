...
(function (std) {
    ...
    (function (example) {
        function test_all() {
            for (var key_3 in std.example)
                if (key_3 != "test_all" && std.example[key_3] instanceof Function)
                    std.example[key_3]();
        }
...
(function (std) {
    ...
    var List = (function (_super) {
        ...
        List.prototype.unique = function (binary_pred) {
            if (binary_pred === void 0) {
                binary_pred = std.equal_to;
            }
            var it = this.begin().next();
            while (!it.equal_to(this.end())) {
                if (std.equal_to(it.value, it.prev().value) == true)
...
/// <reference path="../example/test_all.ts" />
if (typeof (exports) != "undefined")
    for (var key_4 in std)
        exports[key_4] = std[key_4];
