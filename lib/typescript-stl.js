        ...
        var MapContainer = (function (_super) {
            ...
            MapContainer.prototype.rbegin = function () {
                if (this.empty() == true)
                    ...
                    return new std.MapIterator(this, this.data_.end().prev());
            };
            /**
...
(function (std) {
    ...
    var MapReverseIterator = (function (_super) {
        ...
        MapReverseIterator.prototype.prev = function () {
            return new MapReverseIterator(this.map, this.list_iterator_.next());
        };
        /**
         * @inheritdoc
         */
        ...
        MapReverseIterator.prototype.advance = function (step) {
            return new MapReverseIterator(this.map, this.list_iterator_.advance(-1 * step));
        };
    ...
    (function (base) {
        ...
        var SetContainer = (function (_super) {
            ...
            SetContainer.prototype.rbegin = function () {
                return new std.SetReverseIterator(this, this.data_.end().prev());
            };
            /**
             * @inheritdoc
             */
            SetContainer.prototype.rend = function () {
                return new std.SetReverseIterator(this, this.data_.end());
            };
            /* ---------------------------------------------------------
                ELEMENTS
            --------------------------------------------------------- */
...
(function (std) {
    ...
    var SetReverseIterator = (function (_super) {
        ...
        /* ---------------------------------------------------------------
            CONSTRUCTORS
        --------------------------------------------------------------- */
        function SetReverseIterator(source, it) {
            _super.call(this, source, it);
        }
        /* ---------------------------------------------------------
            MOVERS
        --------------------------------------------------------- */
        ...
        SetReverseIterator.prototype.prev = function () {
            return new SetReverseIterator(this.set, this.list_iterator_.next());
        };
        /**
         * @inheritdoc
         */
        SetReverseIterator.prototype.next = function () {
            return new SetReverseIterator(this.set, this.list_iterator_.prev());
        };
        /**
         * @inheritdoc
         */
        SetReverseIterator.prototype.advance = function (n) {
            return new SetReverseIterator(this.set, this.list_iterator_.advance(-1 * n));
        };
...
(function (std) {
    ...
    var Deque = (function (_super) {
        ...
        Deque.prototype.rbegin = function () {
            if (this.empty() == true)
                ...
                return new DequeReverseIterator(this, this.size() - 1);
        };
        /**
         * @inheritdoc
         */
        Deque.prototype.rend = function () {
            return new DequeReverseIterator(this, -1);
        };
        /**
         * @inheritdoc
         */
        ...
        Deque.prototype.erase = function (first, last) {
            ...
            // INDEXING
            var start_index = Math.min(first.index, last.index);
            var size = Math.abs(last.index - first.index);
            this.size_ -= size;
            // PRE-PROCESS
            if (size != 0)
            ...
            // ERASING
            while (size != 0) {
                var indexPair = this.fetch_index(start_index);
        ...
        /* ---------------------------------------------------------------
            PRE & POST-PROCESS
        --------------------------------------------------------------- */
        Deque.prototype.handle_insert = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
        Deque.prototype.handle_erase = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
        /**
         * @hidden
         */
        Deque.prototype.make_iterator = function (index) {
            return new DequeIterator(this, index);
        };
        /* ===============================================================
            UTILITIES
        =============================================================== */
    ...
    var DequeReverseIterator = (function (_super) {
        ...
        /* ---------------------------------------------------------
            CONSTRUCTORS
        --------------------------------------------------------- */
        function DequeReverseIterator(source, index) {
            _super.call(this, source, index);
        }
        /* ---------------------------------------------------------
            MOVERS
        --------------------------------------------------------- */
        ...
        DequeReverseIterator.prototype.prev = function () {
            if (this.index_ >= this.source_.size() - 1)
                ...
                return new DequeReverseIterator(this.deque, this.index_ + 1);
        };
        /**
         * @inheritdoc
         */
        ...
        DequeReverseIterator.prototype.advance = function (n) {
            ...
            if (new_index < 0 || new_index >= this.deque.size())
                ...
                return new DequeReverseIterator(this.deque, new_index);
        };
...
(function (std) {
    ...
    var Vector = (function (_super) {
        ...
        Vector.prototype.rbegin = function () {
            if (this.empty() == true)
                ...
                return new VectorReverseIterator(this, this.size() - 1);
        };
        /**
         * @inheritdoc
         */
        Vector.prototype.rend = function () {
            return new VectorReverseIterator(this, -1);
        };
        /**
         * @inheritdoc
         */
        ...
        Vector.prototype.erase = function (first, last) {
            ...
            if (last.equal_to(this.end())) {
                _super.prototype.splice.call(this, start_index);
                return this.end();
            }
            else
                _super.prototype.splice.call(this, start_index, size);
            return first;
        };
        /* ---------------------------------------------------------------
            ARRAY'S MEMBERS
        ...
        Vector.prototype.shift = function () {
            ...
            return _super.prototype.shift.call(this);
        };
        /**
         * @inheritdoc
         */
        ...
        Vector.prototype.splice = function (start, deleteCount) {
            if (deleteCount === void 0) { deleteCount = this.length - 1; }
            var items = [];
        ...
        /* ---------------------------------------------------------------
            PRE & POST-PROCESS
        --------------------------------------------------------------- */
        Vector.prototype.handle_insert = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
        Vector.prototype.handle_erase = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
        /**
         * @hidden
         */
        Vector.prototype.make_iterator = function (index) {
            return new VectorIterator(this, index);
        };
        /* ===============================================================
            UTILITIES
        =============================================================== */
    ...
    var VectorReverseIterator = (function (_super) {
         ...
         * @param index Sequence number of the element in the source {@link Vector}.
         */
        function VectorReverseIterator(source, index) {
            _super.call(this, source, index);
        }
        /* ---------------------------------------------------------
            MOVERS
        ...
        VectorReverseIterator.prototype.advance = function (n) {
            ...
            if (newIndex < 0 || newIndex >= this.vector.size())
                ...
                return new VectorReverseIterator(this.vector, newIndex);
        };
...
(function (std) {
    ...
    var List = (function (_super) {
        ...
        List.prototype.clear = function () {
            ...
            it.setPrev(it);
            it.setNext(it);
            var prev_begin = this.begin_;
            var prev_end = this.end_;
            this.begin_ = it;
            this.end_ = it;
            this.size_ = 0;
        ...
        List.prototype.erase_by_range = function (first, last) {
            ...
            // CALCULATE THE SIZE
            var size = 0;
            for (var it = first; it.equal_to(last) == false; it = it.next())
                size++;
            // SHRINK
            prev.setNext(last);
            last.setPrev(prev);
        ...
        /* ---------------------------------------------------------------
            POST-PROCESS
        --------------------------------------------------------------- */
        List.prototype.handle_insert = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
        List.prototype.handle_erase = function (first, last) {
            // NOTHING TO DO ESPECIALLY
            // IF YOU WANT TO SPECIFY, EXTENDS AND OVERRIDES THIS
        };
...
(function (std) {
    ...
    var HashSet = (function (_super) {
        ...
        HashSet.prototype.insert_by_range = function (first, last) {
            var my_first = this.end();
            var size = 0;
            for (; !first.equal_to(last); first = first.next()) {
                // TEST WHETER EXIST
                var it = this.find(first.value);
    ...
    var HashMultiSet = (function (_super) {
        ...
        HashMultiSet.prototype.insert_by_range = function (first, last) {
            ...
            if (this.size() + size > this.hash_buckets_.item_size() * std.base.MAX_RATIO)
                this.hash_buckets_.reserve((this.size() + size) * std.base.RATIO);
            // INSERTS
            var my_first = new std.SetIterator(this, this.data_.insert(this.data_.end(), first, last));
            this.handle_insert(my_first, this.end());
        };
        /* ---------------------------------------------------------
            POST-PROCESS
...
(function (std) {
    ...
    var HashMap = (function (_super) {
        ...
        HashMap.prototype.insert_by_range = function (first, last) {
            ...
            for (; !first.equal_to(last); first = first.next()) {
                // TEST WHETER EXIST
                var it = this.find(first.first);
                if (!it.equal_to(this.end()))
                    continue;
                // INSERTS
                this.data_.push_back(std.make_pair(first.first, first.second));
                it = it.prev();
                size++;
            }
            // IF NEEDED, HASH_BUCKET TO HAVE SUITABLE SIZE
    ...
    var HashMultiMap = (function (_super) {
        ...
        HashMultiMap.prototype.insert_by_range = function (first, last) {
            ...
            var my_first = null;
            for (; !first.equal_to(last); first = first.next()) {
                var list_it = this.data_.insert(this.data_.end(), std.make_pair(first.first, first.second));
                var it = new std.MapIterator(this, list_it);
                if (my_first == null)
                    my_first = it;
            }
...
(function (std) {
    ...
    var TreeMap = (function (_super) {
         ...
         * @hidden
         */
        TreeMap.prototype.insert_by_range = function (begin, end) {
            for (; !begin.equal_to(end); begin = begin.next())
                this.insert_by_pair(std.make_pair(begin.first, begin.second));
        };
        /* ---------------------------------------------------------
            POST-PROCESS
        --------------------------------------------------------- */
    ...
    var TreeMultiMap = (function (_super) {
         ...
         * @hidden
         */
        TreeMultiMap.prototype.insert_by_range = function (begin, end) {
            for (; !begin.equal_to(end); begin = begin.next())
                this.insert_by_pair(std.make_pair(begin.first, begin.second));
        };
        /* ---------------------------------------------------------
