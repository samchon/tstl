...
/// <reference path="algorithms/sortings.ts" />

/// <reference path="algorithms/heaps.ts" />
/// <reference path="algorithms/binary_searches.ts" />
/// <reference path="algorithms/partitions.ts" />

/// <reference path="algorithms/union_sets.ts" />
/// <reference path="algorithms/mathmatics.ts" />
/// <reference path="algorithms/randoms.ts" />
