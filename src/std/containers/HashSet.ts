...
namespace std
{
		...
		implements base.IHashSet<T>
	{
		 ...
		 */
		public constructor(begin: IBidirectionalIterator<T>, end: IBidirectionalIterator<T>);
		...
		public constructor(...args: any[])
		{
			...
			{
				// RANGE CONSTRUCTOR
				let first: IBidirectionalIterator<T> = args[0];
				let last: IBidirectionalIterator<T> = args[1];
		 ...
		 * @hidden
		 */
		protected _Insert_by_range<U extends T, InputIterator extends IBidirectionalIterator<U>>
