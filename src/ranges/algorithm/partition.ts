 ...
 * @hidden
 */
type Predicator<Range extends IForwardContainer<any>> =
    (val: IForwardContainer.ValueType<Range>) => boolean;

export function is_partitioned<Range extends IForwardContainer<any>>
    (range: Range, pred: Predicator<Range>): boolean
{
    return base.is_partitioned(begin(range), end(range), pred);
}

export function partition_point<Range extends IForwardContainer<any>>
...
export function partition<Range extends IBidirectionalContainer<any, any>>
...
export function stable_partition<Range extends IBidirectionalContainer<any, any>>
    (range: Range, pred: Predicator<Range>): IBidirectionalContainer.IteratorType<Range>
{
