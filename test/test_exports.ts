...
async function from_dynamic(map: index.HashMap<object, string>, path: string): Promise<void>
{
...
function from_index(map: index.HashMap<object, string>, elem: any): void
{
...
{
    const dynamicMap: index.HashMap<object, string> = new index.HashMap();
    const indexMap: index.HashMap<object, string> = new index.HashMap();
