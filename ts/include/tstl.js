...
(function (std) {
    ...
    (function (base) {
        ...
        var _ListContainer = (function (_super) {
             ...
             * @hidden
             */
            _ListContainer.prototype._Insert_by_val = function (position, val) {
             ...
             * @hidden
             */
            _ListContainer.prototype._Insert_by_repeating_val = function (position, size, val) {
                // INVALID ITERATOR
...
(function (std) {
    ...
    (function (base) {
        ...
        var _MapElementList = (function (_super) {
            ...
            _MapElementList.prototype.get_associative = function () {
...
(function (std) {
    ...
    (function (base) {
        ...
        var _SetElementList = (function (_super) {
            ...
            _SetElementList.prototype.get_associative = function () {
                return this.associative_;
            };
...
(function (std) {
    ...
    (function (base) {
        ...
        var _MapTree = (function (_super) {
            ...
            _MapTree.prototype._Find_by_key = function (key) {
                if (this.root_ == null)
                    return null;
                var node = this.root_;
                while (true) {
            ...
            _MapTree.prototype.upper_bound = function (key) {
                var node = this.find(key);
                if (node == null)
                    return this.map_.end();
                else {
            ...
            _MapTree.prototype.is_equal_to = function (left, right) {
                return std.equal_to(left.first, right.first);
            };
            _MapTree.prototype.is_less = function (left, right) {
...
(function (std) {
    ...
    var TreeSet = (function (_super) {
        ...
        function TreeSet() {
            ...
            // INIT MEMBERS
            _super.call(this) || this;
            _this.tree_ = new std.base._SetTree(_this);
...
(function (std) {
    ...
    var TreeMap = (function (_super) {
        ...
        function TreeMap() {
            ...
            // INIT MEMBERS
            _super.call(this) || this;
            _this.tree_ = new std.base._MapTree(_this);
